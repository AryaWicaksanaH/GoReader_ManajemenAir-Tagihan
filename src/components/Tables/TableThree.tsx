        ...
        <table className="w-full table-auto">
          <thead>
            ...
            <th className="min-w-[10px] px-4 py-4 font-medium text-black dark:text-white xl:pl-11">
              ...
              <th className="min-w-[120px] px-4 py-4 pl-12 font-medium text-black dark:text-white">
                Keterangan
              </th>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <p
                    className={`inline-flex rounded-full bg-opacity-10 px-3 py-1 text-sm font-medium ${
                      packageItem.keterangan === "Penggunaan Normal"
                        ? "bg-success text-success"
                        : packageItem.keterangan === "Penggunaan Tidak Normal"
